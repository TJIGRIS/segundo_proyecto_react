  ...
  return (
    <div className="flex gap-10">
        ...
        <div className="mt-6">
          <div className="flex justify-between gap-6">
            <div className="flex-1">
              ...
              <input className="w-full" type="range" value="66.666" name="" id="" />
            </div>
      ...
      <div className="mt-6">
        ...
        <p className="text-4xl mt-4 text-right"><span className="text-base">$</span> 300,000</p>
      </div>
      </div>
    </div>
  );
